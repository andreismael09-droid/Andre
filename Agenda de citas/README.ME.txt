...
Agendar nueva cita — Registra los datos del paciente, elige especialidad, asigna doctor automáticamente, valida fecha y hora, y evita conflictos de horario.
Ver todas las citas — Lista completa de citas registradas con todos sus datos.
Buscar citas por cédula — Encuentra todas las citas de un paciente usando su número de cédula.
Actualizar estado de cita — Cambia el estado entre Pendiente, Confirmada y Cancelada.
Eliminar cita — Borra una cita del sistema con confirmación previa.
Ver resumen estadístico — Muestra totales por estado y por especialidad.
...
agenda_medica/
  ...
  agenda_medica.py         Código fuente principal
    README.md                Este archivo
    diagramas/
        caso_de_uso.png      Diagrama de casos de uso
        flujo.png            Diagrama de flujo del sistema
